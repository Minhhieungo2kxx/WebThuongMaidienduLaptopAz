...
<head>
    ...
    <style>
        ...
        .login-button {
            ...
            color: #fff;
            border: none;
            border-radius: 6px; /* Đã sửa từ 6-px thành 6px */
            font-size: 18px;
            font-weight: bold;
            cursor: pointer;
...
<body>
    <div class="container">
        <div class="left-section">
            <img src="https://upload.wikimedia.org/wikipedia/commons/0/05/Facebook_Logo_%282019%29.png" alt="Facebook" class="facebook-logo">
        ...
        <div class="right-section">
            ...
            <p class="create-page-link"><a href="#">Tạo Trang</a> dành cho người nổi tiếng, thương hiệu hoặc doanh nghiệp.</p>
        </div>
    </div>
